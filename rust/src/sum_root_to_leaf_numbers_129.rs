...
impl Solution {
    ...
    fn sum_numbers_dfs(root: Option<Rc<RefCell<TreeNode>>>, prev_sum: i32) -> i32 {
        if let Some(node) = root {
            ...
            let left_sum = Self::sum_numbers_dfs(node_borrow.left.clone(), current_sum);
            let right_sum = Self::sum_numbers_dfs(node_borrow.right.clone(), current_sum);
