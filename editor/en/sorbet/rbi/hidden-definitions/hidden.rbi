...
class Mechanize::Chain::PostConnectHook
end
...
class Mechanize::Cookie
  def self.parse(uri, str, log=T.unsafe(nil)); end
end
...
class Mechanize::Page::Meta
  def self.parse(content, uri); end
end
...
class Mechanize::Util
  ...
  def self.from_native_charset(s, code); end

  def self.html_unescape(s); end

  def self.to_native_charset(s, code=T.unsafe(nil)); end
end
...
class Watchman::Call
  ...
  ResponseLevelMap = ::T.let(nil, ::T.untyped)
end
